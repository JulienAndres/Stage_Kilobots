...
# 1 "<command-line>" 2
# 1 "communication.c"
# 1 "/usr/local/include/kilombo.h" 1 3
# 11 "/usr/local/include/kilombo.h" 3
# 1 "/usr/local/include/kilombo/kilolib.h" 1 3



# 1 "/usr/include/jansson.h" 1 3 4
# 11 "/usr/include/jansson.h" 3 4
...
# 12 "/usr/include/jansson.h" 2 3 4
...
# 13 "/usr/include/jansson.h" 2 3 4
# 1 "/usr/lib/gcc/x86_64-linux-gnu/5/include/stdarg.h" 1 3 4
# 14 "/usr/include/jansson.h" 2 3 4

# 1 "/usr/include/jansson_config.h" 1 3 4
# 16 "/usr/include/jansson.h" 2 3 4
# 39 "/usr/include/jansson.h" 3 4
typedef enum {
    JSON_OBJECT,
    JSON_ARRAY,
    JSON_STRING,
...
# 62 "/usr/include/jansson.h" 3 4
typedef long long json_int_t;
# 84 "/usr/include/jansson.h" 3 4
...
# 5 "/usr/local/include/kilombo/kilolib.h" 2 3
# 44 "/usr/local/include/kilombo/kilolib.h" 3
...
# 45 "/usr/local/include/kilombo/kilolib.h" 2 3
# 1 "/usr/local/include/kilombo/message.h" 1 3
...
# 37 "/usr/local/include/kilombo/message.h" 3
typedef struct {
    uint8_t data[9];
    uint8_t type;
    uint16_t crc;
} message_t;
# 46 "/usr/local/include/kilombo/kilolib.h" 2 3
# 1 "/usr/local/include/kilombo/message_crc.h" 1 3
# 32 "/usr/local/include/kilombo/message_crc.h" 3
uint16_t message_crc(const message_t *msg);
# 47 "/usr/local/include/kilombo/kilolib.h" 2 3
# 61 "/usr/local/include/kilombo/kilolib.h" 3
...
# 100 "/usr/local/include/kilombo/kilolib.h" 3
typedef struct {
    int16_t low_gain;
    int16_t high_gain;
...
# 142 "/usr/local/include/kilombo/kilolib.h" 3
...
# 159 "/usr/local/include/kilombo/kilolib.h" 3
extern uint8_t kilo_turn_left;
# 168 "/usr/local/include/kilombo/kilolib.h" 3
extern uint8_t kilo_turn_right;
# 178 "/usr/local/include/kilombo/kilolib.h" 3
extern uint8_t kilo_straight_left;
# 188 "/usr/local/include/kilombo/kilolib.h" 3
extern uint8_t kilo_straight_right;
# 233 "/usr/local/include/kilombo/kilolib.h" 3
extern message_rx_t kilo_message_rx;
# 290 "/usr/local/include/kilombo/kilolib.h" 3
extern message_tx_t kilo_message_tx;
# 306 "/usr/local/include/kilombo/kilolib.h" 3
extern message_tx_success_t kilo_message_tx_success;
# 329 "/usr/local/include/kilombo/kilolib.h" 3
uint8_t estimate_distance(const distance_measurement_t *d);
# 347 "/usr/local/include/kilombo/kilolib.h" 3
void delay(uint16_t ms);
# 363 "/usr/local/include/kilombo/kilolib.h" 3
uint8_t rand_hard();
# 374 "/usr/local/include/kilombo/kilolib.h" 3
uint8_t rand_soft();
# 384 "/usr/local/include/kilombo/kilolib.h" 3
void rand_seed(uint8_t seed);
# 402 "/usr/local/include/kilombo/kilolib.h" 3
int16_t get_ambientlight();
# 413 "/usr/local/include/kilombo/kilolib.h" 3
int16_t get_voltage();
# 426 "/usr/local/include/kilombo/kilolib.h" 3
int16_t get_temperature();
# 475 "/usr/local/include/kilombo/kilolib.h" 3
void set_motors(uint8_t left, uint8_t right);
# 498 "/usr/local/include/kilombo/kilolib.h" 3
void spinup_motors();
# 527 "/usr/local/include/kilombo/kilolib.h" 3
void set_color(uint8_t color);
# 541 "/usr/local/include/kilombo/kilolib.h" 3
void kilo_init();
# 578 "/usr/local/include/kilombo/kilolib.h" 3
void kilo_start(void (*setup)(void), void (*loop)(void));
# 12 "/usr/local/include/kilombo.h" 2 3
# 21 "/usr/local/include/kilombo.h" 3
# 1 "/usr/local/include/kilombo/params.h" 1 3
...
# 4 "/usr/local/include/kilombo/params.h" 2 3
...
# 22 "/usr/local/include/kilombo.h" 2 3
# 2 "communication.c" 2
...
void update_voisins(){
 ...
 for(i=mydata->nb_voisins-1;i>=0;i--){
  if (kilo_ticks-mydata->voisins_liste[i].timestamp > 32){
...
void rxbuffer_push(message_t *msg, distance_measurement_t *dist){
    received_message_t *rmsg = &mydata->RXBuffer[mydata->RXTail];
    rmsg->msg = *msg;
    rmsg->dist = *dist;
    { mydata->RXTail = (mydata->RXTail+1)%8; if ((mydata->RXHead == mydata->RXTail)) { mydata->RXHead = (mydata->RXHead+1)%8; } };
...
void update_mur_from_message(){
 int x_old = 0;
 int x_new = 0;
 if(((mydata->RXHead+1)%8 == mydata->RXTail)){
  if(mydata->cpt_message == 8){
...
void update_from_message(){
 ...
 uint8_t *data = mydata->RXBuffer[mydata->RXHead].msg.data;
 int ID=data[0];
 if(isMur(ID)){
  if(!mydata->wall_detected){
   mydata->wall_detected = 1;
  }
  mydata->wall_detected_timeout = kilo_ticks ;
